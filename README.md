...
|----|----|----|----|----|----|
|Master|kmaster.example.com|192.10.1.1|CentOS 7|4G|2|
|Worker|kworker.example.com|192.10.1.2|CentOS 7|2G|1|
...
```
cat >>/etc/hosts<<EOF
192.10.1.1 kmaster.demo.com kmaster
192.10.1.2 kworker.demo.com kworker
EOF
```
...
```
kubeadm init --apiserver-advertise-address=192.10.1.1 --pod-network-cidr=192.168.0.0/16
```
##### Copy kube config
